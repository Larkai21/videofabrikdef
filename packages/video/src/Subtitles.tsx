...
export const Subtitles: React.FC<{ cues: Cue[]; themeRef: string; design?: DesignTokens }> = ({
  cues,
  themeRef,
  design,
}) => {
  ...
  return <Theme cues={cues} currentMs={currentMs} design={design} safeArea={SAFE_AREA} />;
};
